...
func NewDriver(driverCfg *Config, cfg *rollup.Config, daCfg *near.Config, l2 L2Chain, l1 L1Chain, altSync AltSync, network Network, log log.Logger, snapshotLog log.Logger, metrics Metrics) *Driver {
