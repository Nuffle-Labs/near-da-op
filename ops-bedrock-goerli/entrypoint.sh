...
BLOCK_SIGNER_ADDRESS="0x5eac06af3b1340c5085fde7edd434596322033d8"

RPC_PORT="${RPC_PORT:-8545}"
WS_PORT="${WS_PORT:-8546}"

# if BLOCK_SIGNER_PRIVATE_KEY is empty abort
if [ -z "$BLOCK_SIGNER_PRIVATE_KEY" ]; then
  echo "BLOCK_SIGNER_PRIVATE_KEY is empty, aborting."
  exit 1
fi
